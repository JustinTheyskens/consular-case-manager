...
[TestFixture]
public class GetAvailabilitiesEmpty : BaseTest
{
    public GetAvailabilitiesEmpty() : base("/availabilities") { }

    [Test]
    [Description("Tests the GET /availabilities route returns a status code 200")]
    ...
    [Test]
    [Description("Tests the GET /availabilities route returns an application/json")]
    ...
    [Test]
    [Description("Tests the GET /availabilities returns an empty array")]
...
[TestFixture]
public class GetAvailabilitiesNonEmpty : NonEmptyAvailabilityTest
{
    [Test]
    [Description("Tests that GET /availabilities returns a length 1 array")]
    ...
    [Test]
    [Description("Tests that GET /availabilities returns an array with first element of the added element")]
