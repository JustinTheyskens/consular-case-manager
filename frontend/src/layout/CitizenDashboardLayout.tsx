...
export const UserDashboard = () => {
    ...
    const { data: citizenData, isLoading: citizenLoading } = useGetCitizenByIdQuery(userId!, {
        skip: !userId,
    });
    const name = citizenData ? `${citizenData.firstName} ${citizenData.lastName}` : "Guest";
